...
parser.add_argument("-o", "--outpath", dest="outpath", help="output dir", default = ".")
...
outFile = os.path.join(options.outpath, tmp[-1].replace('.root','_dig_apr1.root'))
...
mufiDet.SetConfPar("MuFilter/VandUpSiPMcalibrationS",0.09*7.*1000.);
mufiDet.SetConfPar("MuFilter/thresholdMufiL", 0.);
mufiDet.SetConfPar("MuFilter/thresholdMufiS", 0.);
mufiDet.SetConfPar("MuFilter/sat_peak", 1000.);
mufiDet.SetConfPar("MuFilter/sat_width", 5.)
mufiDet.SetConfPar("MuFilter/SignalSaturation", 150.);
