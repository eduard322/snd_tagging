...
os.system("condor_submit arg_file={arg_file} N={n_jobs} nEvents={nEvents} out_fold={outfold} outputFolder={outputFolder} sub_files/sim.sub".format(arg_file=args.param, 
                                                                                                    n_jobs=args.njobs,
